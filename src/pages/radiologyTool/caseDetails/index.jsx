...
const CaseDetails = () => {
  ...
  const handleGoBack = () => {
    navigate(`/radiology-annotation-tool`, {
  ...
  const navigateToTool = () => {
    if (patientData?.status === "NEW") {
      ...
      // navigate(
      //   `/radiology-annotation-tool/${currentSlide.slideID}/case-details/tool-editor`,
      //   {
      //     state: {
      //       ...location.state,
      //       tabType,
  ...
  const fetchReport = async () => {
    try {
      const response = await downloadRadiologyReport(caseID);
  ...
  const handleUnAssignCase = async (isDeleteAnnotations) => {
    try {
        ...
        <Modal
          ...
          footer={[
            <Button
              ...
              title="No"
              classes="simple"
              handleClick={() => handleUnAssignCase(true)}
            />,
            <Button
              key="save"
              title="Yes"
            ...
            <Card heading="Patient Information">
              <section className="patient-information-container">
                ...
                <article className="patient-generic-details-wrapper">
                  ...
                  {/* <PatientDetail
                    heading="Annotations"
                    content={patientData?.patient_slides[0]?.annotation}
                    classes="annotations"
                  /> */}
                </article>
