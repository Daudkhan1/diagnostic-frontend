...
export const radiologyTableColumns = (handleNavigate, handleDateSort, sort) => {
  return [
    {
      title: "Case No.",
      dataIndex: "case",
    ...
    },
    {
      ...
      width: "10%",
      render: (_, record) => (
        <p className="bold-table-content">{record.scanType}</p>
      ),
    },
    {
      ...
      width: "10%",
      render: (_, record) => (
        <p className="bold-table-content">{record.scanNumber}</p>
      ),
    },
    {
      title: "Date",
